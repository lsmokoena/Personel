						   ...
						   'insert_img'	: { "modal": true,
											...
											"onSave": function(){
												...
												if($('#imageList').data('current')){
													...
													methods.showMessage.apply(this,["imgErrMsg","Please select the image then click done"]);
													return false;
												}
			...
			var modalElement = $('<div/>',{ id: modalId,
								           class: "modal fade",
								              ...
								              "aria-hidden":"true"
                                                ...
                                                class:"modal-dialog modal-notify modal-danger modal-lg"
								         		}).append($('<div>',{
							            			class:"modal-content"
									         		}).append($('<div>',{
                                                        class:"modal-header primary-color"
									           			}).append($('<p/>',{ class:"heading",
                                                            id:"dialog-title"
									           				}).html(modalHeader))
									         		).append($('<div>',{
									           			class:"modal-body"
